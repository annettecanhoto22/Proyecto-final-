class EntidadGeografica:
    """Clase padre que abarca el nombre de cada identidad geográfica"""  
    def __init__(self, nombre: str):
        self.nombre = nombre

class Localidad(EntidadGeografica):
    """Representa una localidad puntual dentro de un municipio, con sus coordenadas geográficas (si las tiene). Hereda de EntidadGeografica porque es un lugar con nombre"""  
    ...
    def __str__(self):
        """Devuelve una representación en texto del objeto y verifica si el objeto cuenta con coordenadas geográficas definidas"""
...
class Municipio(EntidadGeografica):
    """Representa un municipio y guarda la lista de localidades que le pertenecen. También hereda de EntidadGeografica por compartir el atributo nombre""" 
    ...
    def obtener_localidades_con_coordenadas(self):
        """Devuelve una lista con las localidades del municipio que sí tienen coordenadas válidas"""
        lista_validas = []
    ...
    def porcentaje_con_coordenadas(self):
        """Calcula el porcentaje de localidades del municipio que tienen coordenadas geográficas registradas"""
...
class DatoMeteorologico:
    """Clase madre que agrupa temperatura, humedad relativa y velocidad del viento"""
...
class ClimaActual(DatoMeteorologico):
    """Guarda el resultado de una consulta de clima para una localidad específica. Hereda de DatoMeteorologico para reutilizar los atributos climáticos básicos"""
...
class RegistroDiario(DatoMeteorologico):
    """Representa un registro meteorológico de un día puntual, obtenido de la API. También hereda de DatoMeteorologico y agrega la fecha y la precipitación del día."""
...
class ResumenPeriodo:
    """Clase madre que acumula los datos meteorológicos de varios registros diarios pertenecientes a un mismo periodo y calcula sus promedios"""
